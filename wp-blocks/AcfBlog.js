				...
				<div className='flex flex-row flex-wrap lg:justify-start mb-[50px] lg:mb-0'>
					{blog.map((post, index) => {
						...
						return (
                            <div
								key={index}
								className='blog-card w-full sm:w-1/2 lg:w-[33.3%] px-[5px] mb-[10px] rounded-[10px] relative'
							>
								<div className='border-[#0000000d] border-[1px] rounded-[10px] h-full'>
									...
									<div className='p-[30px] card-content'>
										<div className='text-[12px] font-[400] text-[#757575] flex lg:pb-0 mb-[20px]'>
											...
											<span className='relative z-50 mx-[5px]'>
												{' '}
												| 4 min read{' '}
											</span>
										</div>
										<a
											className='cursor-pointer blog-title'
											href='#'
										>
											<h3 className='relative z-50 text-[22px] font-[600] text-secondary leading-[30px]'>
												{' '}
												{post?.title}{' '}
											</h3>
										</a>
										<div className='view_more_container read-article'>
											<Link
                                                href={post.link}
                                                className='text-[#0AADE5] text-[16px] flex relative hover-arrow mt-[20px]'>
                                                Learn More<Image
