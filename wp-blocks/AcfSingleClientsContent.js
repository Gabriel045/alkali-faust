			...
			>
				{sections.map((section, index) => {
					...
					return (
						...
						>
							<div
								ref={contentSections.current[index]}
								className={`${index} left-border py-[82px] px-[36px] gray-border`}
							>
								<h4
									className='text-background text-[20px] font-[600] mb-[26px]'
								...
								<div className='flex flex-nowrap gap-[20px] py-[20px]'>
									<div className={`${section.image2 ? 'w-1/2' : 'w-full'}`}>
										<Image
											...
											className={`${
												section.image2 ? 'h-[200px] lg:h-[420px]' : ''
									...
									{section.image2 && (
										<div className='w-1/2'>
											<Image
												...
												className={
													'h-[200px] lg:h-[420px] rounded-[20px] object-cover'
												}
												alt='Picture of the author'
											/>
										</div>
