...
const TestimonialResponsive = loadable(() =>
	import('../components/TestimonialResponsive/TestimonialResponsive')
)
		...
		<section className=' bg-background relative'>
			<div className='block_content w-full relative'>
				<div className='pb-[60px] lg:pb-[120px] flex flex-wrap  lg:flex-nowrap w-full'>
					<h2 className='w-full mb-[50px] lg:mb-0 lg:w-[60%] text-[#fff]'>
						{' '}
						{title}{' '}
					</h2>
				...
				<div className='flex-row flex-wrap lg:flex hidden '>
					{testimonials.map((testimonial, index) => {
						return (
							<div
								key={index}
								className='testimonial-container lg:w-[32%] p-[30px]  rounded-[10px] mb-[20px] mr-[2%] border-custom z-50 [&:nth-child(3n)]:mr-0 relative h-[295px]'
							>
								...
								<p className='text-[#fff] font-[400] text-[18px] leading-[35px] relative mt-[30px]'>
									{' '}
