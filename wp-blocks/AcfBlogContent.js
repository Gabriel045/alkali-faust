...
export default function AcfBlogContent({
	data,
	categories,
	socialMedia,
	type,
	...
	return (
        <section className='relative'>
			<Image
				...
				style={{}} // optional
				className={
					'hidden lg:block absolute z-10 top-[10%] left-[-80px] rotate-180'
				}
							...
							<div className='sticky top-[40px] bg-white z-[100]'>
								...
								<div className='flex gap-[8px] py-[26px] border-b-[1px] border-[#D8D8D8]'>
									<Link
                                        ...
                                        target='_blank'
                                        className='cursor-pointer hover:translate-y-[2px] transform'>
								...
								<div className='mt-[26px]'>
									<Link
                                        href={categoryUrl ?? '#'}
                                        className='inline-block bg-primary text-[white] lg:text-[12px] font-[500] rounded-[4px] p-[12px] transform hover:translate-y-[2px] '>
						...
						{type == 'job' && (
							<div className=''>
								<Link
                                    href={cta?.url ?? '#'}
                                    target={cta?.target}
                                    className='hov flex w-fit bg-primary text-[white] lg:text-[16px] font-[400] rounded-[4px] px-[20px] py-[8px] transform hover:translate-y-[2px] '>
                                    Apply Now<Image
