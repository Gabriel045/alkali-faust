...
export default function HeroSingleBlog({
	featuredImage,
	excerpt,
	title,
	categories,
			...
			<div className='block_content flex flex-wrap w-full hero'>
				{!excerpt && (
					<>
						<div className='w-full lg:w-[55%] pr-[60px]'>
							...
							<div className='text-[18px] font-[400] text-[#ffffff99] flex items-end lg:pb-0 mt-[8px] flex-wrap xl:flex-nowrap'>
								<div className='flex items-end w-full xl:w-auto mb-[40px] xl:mb-0'>
									...
									<span className='text-[#fff] text-[18px] ml-[16px] mr-[30px] leading-[27px]'>
										{' '}
										Alkali{' '}
									</span>
								</div>
						...
						<div className='hidden lg:block w-full lg:w-[45%] relative z-[]'>
							<Image
				...
				{excerpt && (
					<div>
						...
						<div
							className='text-[#ffffffab] my-[30px]'
							dangerouslySetInnerHTML={{ __html: excerpt }}
						/>
						<div className='flex gap-[24px] flex-row'>
							<span className='flex items-center text-[#ffffff8c] text-[16px] font-[300]'>
								<Image
