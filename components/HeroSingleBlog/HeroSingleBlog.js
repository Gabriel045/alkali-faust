...
export default function HeroSingleBlog({featuredImage,excerpt,title,categories,date}) {
        ...
        <section className="bg-background relative">
            <div className="block_content flex flex-wrap w-full hero">
                ...
                }
                {
                    ...
                    <div>
                        <h1 className="my-[36px] text-white" style={{lineHeight: 'normal'}}>{title}</h1>
                        <div className="text-[#ffffffab] my-[30px]" dangerouslySetInnerHTML={{__html: excerpt}} />
