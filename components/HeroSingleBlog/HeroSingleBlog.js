                ...
                <div className="block_content flex flex-wrap w-full hero">
                    <div className="w-full lg:w-[55%] pr-[60px]">
                        <div className="hidden lg:block">
                            <a href="/blog/<?php echo $categories[0]->slug ?>" className="inline-block bg-primary text-[white] lg:text-[12px] font-[500] rounded-[4px] p-[12px] transform hover:translate-y-[2px] ">Resource Category</a>
                        </div>
