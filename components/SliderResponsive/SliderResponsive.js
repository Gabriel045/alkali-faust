                ...
                >
                    {cards.map((card, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className='slick-slide  w-full'
                            >
                                <h4 className='text-[#232628]'>{steps[index]}</h4>
                                <div className='item-content mb-[70px]'>
                                    <p className='paragraph text-[#23242499] pt-[26px] pb-[16px]'>
                                        {' '}
                                        {card.paragraph}{' '}
                                    </p>
                                    <Link
                                        href={card?.learnMore?.url ?? '#'}
                                        className='text-[#0AADE5] text-[16px] flex'
                                        target={card?.learnMore?.target}>
                                ...
                                <div className='flex lg:block items-end   relative h-[524px] z-50'>
                                    ...
                                    <div className='flex flex-wrap lg:flex-nowrap absolute p-[20px] pb-[40px] lg:p-[50px]'>
                                        <p className='w-full lg:w-[60%] text-white text-[23px] font-[600] leading-[37px] mb-[25px] lg:mb-0'>
                                            {' '}
                                            {card.textImage}{' '}
                                        </p>
                                        <Link
