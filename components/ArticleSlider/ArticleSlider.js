...
export default class SimpleSlider extends Component {
	render() {
		...
		const posts = this.props?.cards?.posts?.edges
			? this.props?.cards?.posts?.edges
			: []
					...
					<div className='articles hidden lg:flex w-[60%] justify-end gap-[20px]'>
						...
						>
							...
							>
								<rect
									...
									height='49.6667'
									rx='24.8333'
									transform='rotate(180 50.6641 51.5078)'
									fill='#fff'
								/>
								<path
									className='icon-arrow'
									d='M31.6641 26.6745L19.9974 26.6745M19.9974 26.6745L25.8307 32.5078M19.9974 26.6745L25.8307 20.8411'
									stroke='#0AADE5'
									strokeWidth='2'
									strokeLinecap='round'
						...
						>
							...
							>
								...
								<path
									className='icon-arrow'
									d='M19.9974 26.6745H31.6641M31.6641 26.6745L25.8307 20.8411M31.6641 26.6745L25.8307 32.5078'
									stroke='#0AADE5'
									strokeWidth='2'
									strokeLinecap='round'
									strokeLinejoin='round'
					...
					>
						{posts.map((card, index) => {
							return (
                                <div
									key={index}
									className='rounded-[10px] bg-[#F9F9F9] slick-slide'
								>
									<Link href={card?.node.link} className='cursor-pointer'>
									...
									<div className='py-[45px] px-[35px] articles-border'>
										<p className='text-[#232323] text-[22px] font-[600] leading-[23px]'>
											{' '}
											{card?.node?.title}{' '}
										</p>
										...
										<Link
                                            href={card?.node.link}
                                            className='text-[#0AADE5] text-[16px] flex hover-arrow mt-[20px]'>
                                            Learn More<Image
